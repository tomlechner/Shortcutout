...
kmi = km.keymap_items.new('view3d.cycle_cameras', 'LEFT_ARROW', 'PRESS', shift=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'direction', 'BACKWARD')
kmi = km.keymap_items.new('view3d.cycle_cameras', 'RIGHT_ARROW', 'PRESS', shift=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'direction', 'FORWARD')
kmi = km.keymap_items.new('export.asset_flinger', 'E', 'PRESS', shift=True, ctrl=True, alt=True)
kmi = km.keymap_items.new('view3d.asset_flinger', 'A', 'PRESS', shift=True, ctrl=True, alt=True)
